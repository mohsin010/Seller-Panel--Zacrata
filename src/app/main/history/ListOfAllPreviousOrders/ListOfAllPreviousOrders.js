...
// function HomePage() {
class ListOfAllPreviousOrdersPage extends React.Component {
    ...
    componentWillMount() {
        ...
        axios.get('https://api.zacarta.com/api/seller/order/getOrders?type=3', {
            headers: headers
        }).then(res => {
...
ListOfAllPreviousOrdersPage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ListOfAllPreviousOrdersPage);