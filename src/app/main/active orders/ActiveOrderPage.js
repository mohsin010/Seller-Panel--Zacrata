...
// function HomePage() {
class ActiveOrderPage extends React.Component {
    ...
    componentWillMount() {
        ...
        axios.get('https://api.zacarta.com/api/seller/order/getOrders?type=2', {
            headers: headers
        }).then(res => {
...
ActiveOrderPage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ActiveOrderPage);