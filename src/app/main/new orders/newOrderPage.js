...
// function HomePage() {
class NewOrdersPage extends React.Component {
    ...
    componentWillMount() {
        ...
        axios.get('https://api.zacarta.com/api/seller/order/getOrders?type=1', {
            headers: headers
        }).then(res => {
...
NewOrdersPage.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(NewOrdersPage);